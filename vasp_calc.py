...
strains = [0, 0.4, 0.8, 1.2, 1.6, -0.4, -0.8, -1.2, -1.6]
current_dir = os.getcwd()
files_to_copy = ['INCAR_relax','POSCAR' ,'INCAR_dos', 'POTCAR', 'KPOINTS']
for i in strains:
    dirname = f"Metal_{i:.1f}"
...
directories = ["Metal_0.0", "Metal_0.4", "Metal_0.8", "Metal_1.2", "Metal_1.6", "Metal_-0.4", "Metal_-0.8", "Metal_-1.2", "Metal_-1.6"]
